...
pub const struct_ObjString = extern struct {
    obj: Obj,
    length: c_int,
    chars: [*c]u8,
    hash: u64,
};
pub const ObjString = struct_ObjString;
pub const VAL_BOOL: c_int = 0;
pub const VAL_NIL: c_int = 1;
pub const VAL_INT: c_int = 2;
pub const VAL_DOUBLE: c_int = 3;
pub const VAL_OBJ: c_int = 4;
pub const VAL_COMPLEX: c_int = 5;
pub const ValueType = c_uint;
...
pub extern fn valuesEqual(a: Value, b: Value) bool;
pub extern fn initValueArray(array: [*c]ValueArray) void;
pub extern fn writeValueArray(array: [*c]ValueArray, value: Value) void;
pub extern fn freeValueArray(array: [*c]ValueArray) void;
pub extern fn printValue(value: Value) void;
pub const OP_CONSTANT: c_int = 0;
pub const OP_NIL: c_int = 1;
pub const OP_TRUE: c_int = 2;
pub const OP_FALSE: c_int = 3;
pub const OP_POP: c_int = 4;
pub const OP_GET_LOCAL: c_int = 5;
pub const OP_SET_LOCAL: c_int = 6;
pub const OP_GET_GLOBAL: c_int = 7;
pub const OP_DEFINE_GLOBAL: c_int = 8;
pub const OP_SET_GLOBAL: c_int = 9;
pub const OP_GET_UPVALUE: c_int = 10;
pub const OP_SET_UPVALUE: c_int = 11;
pub const OP_GET_PROPERTY: c_int = 12;
pub const OP_SET_PROPERTY: c_int = 13;
pub const OP_GET_SUPER: c_int = 14;
pub const OP_EQUAL: c_int = 15;
pub const OP_GREATER: c_int = 16;
pub const OP_LESS: c_int = 17;
pub const OP_ADD: c_int = 18;
pub const OP_SUBTRACT: c_int = 19;
pub const OP_MULTIPLY: c_int = 20;
pub const OP_DIVIDE: c_int = 21;
pub const OP_NOT: c_int = 22;
pub const OP_NEGATE: c_int = 23;
pub const OP_PRINT: c_int = 24;
pub const OP_JUMP: c_int = 25;
pub const OP_JUMP_IF_FALSE: c_int = 26;
pub const OP_LOOP: c_int = 27;
pub const OP_CALL: c_int = 28;
pub const OP_INVOKE: c_int = 29;
pub const OP_SUPER_INVOKE: c_int = 30;
pub const OP_CLOSURE: c_int = 31;
pub const OP_CLOSE_UPVALUE: c_int = 32;
pub const OP_RETURN: c_int = 33;
pub const OP_CLASS: c_int = 34;
pub const OP_INHERIT: c_int = 35;
pub const OP_METHOD: c_int = 36;
...
pub extern fn initChunk(chunk: [*c]Chunk) void;
pub extern fn freeChunk(chunk: [*c]Chunk) void;
pub extern fn writeChunk(chunk: [*c]Chunk, byte: u8, line: c_int) void;
pub extern fn addConstant(chunk: [*c]Chunk, value: Value) c_int;
...
pub export fn disassembleInstruction(arg_chunk: [*c]Chunk, arg_offset: c_int) c_int {
    ...
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, instruction)))) {
            ...
            @as(c_int, 15) => return simpleInstruction("OP_EQUAL", offset),
            @as(c_int, 16) => return simpleInstruction("OP_GREATER", offset),
            @as(c_int, 17) => return simpleInstruction("OP_LESS", offset),
            @as(c_int, 18) => return simpleInstruction("OP_ADD", offset),
            @as(c_int, 19) => return simpleInstruction("OP_SUBTRACT", offset),
            @as(c_int, 20) => return simpleInstruction("OP_MULTIPLY", offset),
            @as(c_int, 21) => return simpleInstruction("OP_DIVIDE", offset),
            @as(c_int, 22) => return simpleInstruction("OP_NOT", offset),
            @as(c_int, 23) => return simpleInstruction("OP_NEGATE", offset),
            @as(c_int, 24) => return simpleInstruction("OP_PRINT", offset),
            @as(c_int, 25) => return jumpInstruction("OP_JUMP", @as(c_int, 1), chunk, offset),
            @as(c_int, 26) => return jumpInstruction("OP_JUMP_IF_FALSE", @as(c_int, 1), chunk, offset),
            @as(c_int, 27) => return jumpInstruction("OP_LOOP", -@as(c_int, 1), chunk, offset),
            @as(c_int, 28) => return byteInstruction("OP_CALL", chunk, offset),
            @as(c_int, 29) => return invokeInstruction("OP_INVOKE", chunk, offset),
            @as(c_int, 30) => return invokeInstruction("OP_SUPER_INVOKE", chunk, offset),
            @as(c_int, 31) => {
                {
                    offset += 1;
                    var constant: u8 = (blk: {
            ...
            @as(c_int, 32) => return simpleInstruction("OP_CLOSE_UPVALUE", offset),
            @as(c_int, 33) => return simpleInstruction("OP_RETURN", offset),
            @as(c_int, 34) => return constantInstruction("OP_CLASS", chunk, offset),
            @as(c_int, 35) => return simpleInstruction("OP_INHERIT", offset),
            @as(c_int, 36) => return constantInstruction("OP_METHOD", chunk, offset),
            else => {
...
pub extern fn initTable(table: [*c]struct_Table) void;
pub extern fn freeTable(table: [*c]struct_Table) void;
pub extern fn findEntry(entries: [*c]struct_Entry, capacity: c_int, key: [*c]ObjString) [*c]struct_Entry;
pub extern fn tableGet(table: [*c]struct_Table, key: [*c]ObjString, value: [*c]Value) bool;
pub extern fn adjustCapacity(table: [*c]struct_Table, capacity: c_int) void;
pub extern fn tableSet(table: [*c]struct_Table, key: [*c]ObjString, value: Value) bool;
pub extern fn tableDelete(table: [*c]struct_Table, key: [*c]ObjString) bool;
pub extern fn tableAddAll(from: [*c]struct_Table, to: [*c]struct_Table) void;
pub extern fn tableFindString(table: [*c]struct_Table, chars: [*c]const u8, length: c_int, hash: u64) [*c]ObjString;
pub extern fn tableRemoveWhite(table: [*c]struct_Table) void;
pub extern fn markTable(table: [*c]struct_Table) void;
pub const OBJ_CLOSURE: c_int = 0;
pub const OBJ_FUNCTION: c_int = 1;
pub const OBJ_INSTANCE: c_int = 2;
pub const OBJ_NATIVE: c_int = 3;
pub const OBJ_STRING: c_int = 4;
pub const OBJ_UPVALUE: c_int = 5;
pub const OBJ_BOUND_METHOD: c_int = 6;
pub const OBJ_CLASS: c_int = 7;
...
pub const struct_ObjUpvalue = extern struct {
    obj: Obj,
    location: [*c]Value,
    closed: Value,
    next: [*c]struct_ObjUpvalue,
};
pub const ObjUpvalue = struct_ObjUpvalue;
...
pub extern fn newBoundMethod(receiver: Value, method: [*c]ObjClosure) [*c]ObjBoundMethod;
pub extern fn newClass(name: [*c]ObjString) [*c]ObjClass;
pub extern fn newClosure(function: [*c]ObjFunction) [*c]ObjClosure;
pub extern fn newFunction(...) [*c]ObjFunction;
pub extern fn newInstance(klass: [*c]ObjClass) [*c]ObjInstance;
pub extern fn newNative(function: NativeFn) [*c]ObjNative;
pub extern fn allocateString(chars: [*c]u8, length: c_int, hash: u64) [*c]ObjString;
pub extern fn hashString(key: [*c]const u8, length: c_int) u64;
pub extern fn takeString(chars: [*c]u8, length: c_int) [*c]ObjString;
pub extern fn copyString(chars: [*c]const u8, length: c_int) [*c]ObjString;
pub extern fn newUpvalue(slot: [*c]Value) [*c]ObjUpvalue;
pub extern fn printObject(value: Value) void;
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /snap/zig/8241/lib/include/stddef.h:111:9
...
pub const BOOL_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:58:9
pub const NIL_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:59:9
pub const INT_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:60:9
pub const DOUBLE_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:61:9
pub const OBJ_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:62:9
pub const COMPLEX_VAL = @compileError("unable to translate C expr: unexpected token '{'"); // ./../include/value.h:63:9
...
pub const mufi_debug_h = "";
pub const mufi_chunk_h = "";
pub const mufi_common_h = "";
...
pub const DEBUG_PRINT_CODE = "";
pub const DEBUG_TRACE_EXECUTION = "";
pub const DEBUG_STRESS_GC = "";
pub const DEBUG_LOG_GC = "";
pub const UINT8_COUNT = UINT8_MAX + @as(c_int, 1);
pub const mufi_value_h = "";
...
pub const mufi_object_h = "";
pub const mufi_table_h = "";
