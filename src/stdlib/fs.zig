...
pub fn create_file(argc: c_int, args: [*c]Value) Value {
...
pub fn write_file(argc: c_int, args: [*c]Value) Value {
...
pub fn read_file(argc: c_int, args: [*c]Value) Value {
...
pub fn delete_file(argc: c_int, args: [*c]Value) Value {
...
pub fn create_dir(argc: c_int, args: [*c]Value) Value {
...
pub fn delete_dir(argc: c_int, args: [*c]Value) Value {
