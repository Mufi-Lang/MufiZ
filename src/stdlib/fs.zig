...
pub fn create_file(argc: i32, args: [*c]Value) Value {
...
pub fn write_file(argc: i32, args: [*c]Value) Value {
...
pub fn read_file(argc: i32, args: [*c]Value) Value {
...
pub fn delete_file(argc: i32, args: [*c]Value) Value {
...
pub fn create_dir(argc: i32, args: [*c]Value) Value {
...
pub fn delete_dir(argc: i32, args: [*c]Value) Value {
