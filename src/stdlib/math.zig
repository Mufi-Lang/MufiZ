...
pub fn ln(argc: i32, args: [*c]Value) Value {
...
/// log2(double) double
pub fn log2(argc: i32, args: [*c]Value) Value {
...
/// log10(double) double
pub fn log10(argc: i32, args: [*c]Value) Value {
...
/// sin(double) double
pub fn sin(argc: i32, args: [*c]Value) Value {
...
/// cos(double) double
pub fn cos(argc: i32, args: [*c]Value) Value {
...
/// tan(double) double
pub fn tan(argc: i32, args: [*c]Value) Value {
...
/// asin(double) double
pub fn asin(argc: i32, args: [*c]Value) Value {
...
/// acos(double) double
pub fn acos(argc: i32, args: [*c]Value) Value {
...
/// atan(double) double
pub fn atan(argc: i32, args: [*c]Value) Value {
...
pub fn complex(argc: i32, args: [*c]Value) Value {
...
pub fn abs(argc: i32, args: [*c]Value) Value {
...
pub fn phase(argc: i32, args: [*c]Value) Value {
...
pub fn sfc(argc: i32, args: [*c]Value) Value {
    _ = args;
...
pub fn rand(argc: i32, args: [*c]Value) Value {
    _ = args;
    if (argc != 0) return stdlib_error("rand() expects no arguments!", .{ .argn = argc });
    var seed_bytes: [8]u8 = undefined;
    std.crypto.random.bytes(&seed_bytes);
...
pub fn randn(argc: i32, args: [*c]Value) Value {
    _ = args;
...
pub fn pow(argc: i32, args: [*c]Value) Value {
...
pub fn sqrt(argc: i32, args: [*c]Value) Value {
...
pub fn ceil(argc: i32, args: [*c]Value) Value {
...
pub fn floor(argc: i32, args: [*c]Value) Value {
...
pub fn round(argc: i32, args: [*c]Value) Value {
...
pub fn max(argc: i32, args: [*c]Value) Value {
...
pub fn min(argc: i32, args: [*c]Value) Value {
