...
pub fn ln(argc: c_int, args: [*c]Value) Value {
...
/// log2(double) double
pub fn log2(argc: c_int, args: [*c]Value) Value {
...
/// log10(double) double
pub fn log10(argc: c_int, args: [*c]Value) Value {
...
/// sin(double) double
pub fn sin(argc: c_int, args: [*c]Value) Value {
...
/// cos(double) double
pub fn cos(argc: c_int, args: [*c]Value) Value {
...
/// tan(double) double
pub fn tan(argc: c_int, args: [*c]Value) Value {
...
/// asin(double) double
pub fn asin(argc: c_int, args: [*c]Value) Value {
...
/// acos(double) double
pub fn acos(argc: c_int, args: [*c]Value) Value {
...
/// atan(double) double
pub fn atan(argc: c_int, args: [*c]Value) Value {
...
pub fn complex(argc: c_int, args: [*c]Value) Value {
...
pub fn abs(argc: c_int, args: [*c]Value) Value {
...
pub fn phase(argc: c_int, args: [*c]Value) Value {
...
pub fn sfc(argc: c_int, args: [*c]Value) Value {
    _ = args;
...
pub fn rand(argc: c_int, args: [*c]Value) Value {
    _ = args;
    if (argc != 0) return stdlib_error("rand() expects no arguments!", .{ .argn = argc });
    var seed_bytes: [8]u8 = undefined;
    std.crypto.random.bytes(&seed_bytes);
...
pub fn randn(argc: c_int, args: [*c]Value) Value {
    _ = args;
...
pub fn pow(argc: c_int, args: [*c]Value) Value {
...
pub fn sqrt(argc: c_int, args: [*c]Value) Value {
...
pub fn ceil(argc: c_int, args: [*c]Value) Value {
...
pub fn floor(argc: c_int, args: [*c]Value) Value {
...
pub fn round(argc: c_int, args: [*c]Value) Value {
...
pub fn max(argc: c_int, args: [*c]Value) Value {
...
pub fn min(argc: c_int, args: [*c]Value) Value {
