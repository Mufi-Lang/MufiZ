...
//     /// Iterator methods (similar to FloatVector)
//     pub fn next(self: Self) ?Value {
//         if (self.pos >= @as(usize, @intCast(self.count))) return null;
//         const value = self.get(@intCast(self.pos));
//         self.pos += 1;
//         return value;
//     }

//     pub fn has_next(self: Self) bool {
//         return self.pos < @as(usize, @intCast(self.count));
//     }

//     pub fn peek(self: Self) ?Value {
//         if (self.pos >= @as(usize, @intCast(self.count))) return null;
//         return self.get(@intCast(self.pos));
//     }
...
//         self.pos = @min(self.pos + n, @as(usize, @intCast(self.count)));
//     }
// };

// // Helper function to print a Value (would normally be in value.zig)
// fn printValue(value: Value) void {
//     // This is a simplified version - actual implementation would handle all value types
//     if (value.is_number()) {
//         if (value.is_int()) {
