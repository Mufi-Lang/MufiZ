...
fn runComparison() !void {
    ...
    std.debug.print("V2 Math: {} functions\n", .{v2_stats.math_functions});
    std.debug.print("V2 Collections: {} functions\n", .{v2_stats.collections_functions});
    std.debug.print("V2 Filesystem: {} functions\n", .{v2_stats.fs_functions});
    std.debug.print("V2 Network: {} functions\n", .{v2_stats.network_functions});
    std.debug.print("V2 Matrix: {} functions\n", .{v2_stats.matrix_functions});
